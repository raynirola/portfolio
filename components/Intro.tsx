...
const GitHubIcon = (props: Pick<SVGProps<SVGSVGElement>, 'className'>) => {
  return (
    <svg viewBox="0 0 496 512" stroke="currentColor" height="1em" width="1em" fill="currentColor" {...props}>
...
const SendMailIcon = (props: Pick<SVGProps<SVGSVGElement>, 'className'>) => {
  return (
    <svg height="1em" width="1em" {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
      <path
        fillRule="evenodd"
...
const TwitterIcon = (props: Pick<SVGProps<SVGSVGElement>, 'className'>) => {
  return (
    <svg stroke="currentColor" fill="currentColor" viewBox="0 0 512 512" height="1em" width="1em" {...props}>
...
const HeroPattern = (props: Pick<SVGProps<SVGSVGElement>, 'className'>) => {
  return (
    <svg width={504} height={410} viewBox="0 0 504 410" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      <path
      ...
      <defs>
        ...
        <linearGradient id="prefix__paint1_linear" x1={132} y1={181} x2={132} y2={409} gradientUnits="userSpaceOnUse">
          <stop offset={0.401} stopColor="currentColor" />
          <stop offset={1} stopColor="currentColor" />
        </linearGradient>
      </defs>
